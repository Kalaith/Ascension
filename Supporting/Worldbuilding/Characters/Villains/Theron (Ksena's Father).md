...
- Dies as the old command structure collapses; his fall directly enables institutional reset.
## Deep Dive

Detailed Description:
- Physical Profile: Native non-human ascended regime patriarch with imposing elder-ring presence.
- Before Ascension: Tanned skin, dark hair, dark eyes, broad-shouldered military-governance build.
- After Ascension: Pale clear skin, bright luminous eyes, severe idealized features, unmistakably non-human in controlled presentation.
- Visual Markers: Council flame attire, strict composure, minimal wasted motion.
- Presence: Authoritative and clinical, projects inevitability rather than emotion.
...
- Combat/Field: Defensive architecture weaponization, controlled wave pressure.
- Strategic Value (as threat): System-level control of restraints and ritual infrastructure.
